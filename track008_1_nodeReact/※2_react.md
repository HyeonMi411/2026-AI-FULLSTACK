...

{
  ...
  "dependencies": {
    ...
    "cross-env": "^7.0.2",  // 운영체제 상관없이 (window, mac, linus) 환경변수 설정
    "dotenv": "^16.0.1",    // 중요키
    "express": "^5.2.1",    // 웹서버
    ...
    "pm2": "^4.5.0",    // 베포환경에서 node.js 프로세스 계속실행되게 관리 
...
6. 개발 ( reducer - sage - view )  (2) sagga
...
7. 개발 ( reducer - sage - view )  (2) store
...
app.use( cors({
  origin: 'http://localhost:3000' ,   // 프로트엔드 주소를 명시
  credentials : true                  // 쿠키/세션 허용
}));
``` 

실습0) front - pages- [ _app.js ] 