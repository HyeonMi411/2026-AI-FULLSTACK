...
void main() {
  ...
  // 8. 비동기 처리 (Future : 미래에 완료될 작업, async/await : 작업할때 까지 기다리기 ,  then : 작업완료후)
  fetchData().then( (value)=>  print("then: $value") );   //#1   fetchData()  2초타이머 / #2 then 예약
  testAsync();  //#3. testAsync() 다른 2초타이머
}
// 비동기 함수 정의 (2초 후 완료)
