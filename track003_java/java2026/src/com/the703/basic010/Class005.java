...
class Farm{
	//상태(멤버변수)
	String name;	//인스턴스변수- heap area - new 0 - 생성자
	int age;	
	static String FarmMame="(주) 동물농장";	//클래스변수 - 클래스명.변수명
	...
	void show() { //인스턴스 메서드 - heap area - new 0 - 생성자
		System.out.println("\n\n:::::::::::::::::");		
...
public class Class005 {
	public static void main(String[] args) {
		System.out.println("\n\n0. 동물농장");
		System.out.println("::회사이름 > " + Farm.FarmMame);
		...
		cat.name = "뽀비";	dog.age = 7;	/*dog.numPlus(); */	Farm.numPlus();	
		dog.show();
	}
}
/*************
