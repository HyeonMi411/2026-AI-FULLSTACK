...
//		##### 3. 입력받기 - 정답이면 멈추기		
		...
		System.out.println("y를 입력하세요."); char ch = scanner.next().charAt(0);
		if(ch == 'y') { System.out.println("스레드를 중단합니다."); } 
//		else { System.out.println("스레드를 중단합니다."); }		
