...
public class Network003_book {
	public static void main(String[] args) {
		try {
			...
			//			Client ID           1HT4TbVO5lJLLpslISyU
			//			Client Secret       g2fujBWYYw
			conn.setRequestMethod("GET");
			conn.setRequestProperty("X-Naver-Client-Id"		, "1HT4TbVO5lJLLpslISyU");
			conn.setRequestProperty("X-Naver-Client-Secret"	, "g2fujBWYYw");
