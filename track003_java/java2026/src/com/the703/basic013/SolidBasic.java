...
//1. s: 단일책임 원칙
class CookieMaker{
	public void bakeDookie(String type) { System.out.println(type + " 쿠키를 궈요");}
}
...
class ChocoBananaCookie	implements Cookie{  @Override public void make() { System.out.println("초코바나나쿠기");	}	}
...
public class SolidBasic {
	public static void main(String[] args) {
		...
		maker.bakeDookie("초코");	maker.bakeDookie("오트밀");	maker.bakeDookie("라즈베리");
		
		//2. o : 개방-폐쇄의 원칙 + L : 리스코프치환
		System.out.println("2. o: 개방폐쇄(레시피 추가) + 1 : 리스코프(공장-어떤쿠키든지 굽기 가능) 치환");
