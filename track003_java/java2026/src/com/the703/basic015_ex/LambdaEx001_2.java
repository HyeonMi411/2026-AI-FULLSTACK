...
public class LambdaEx001_2 {
	public static void main(String[] args) {
//		Printer p1 = new Printer() {
//			@Override public void print(String msg) { System.out.println("익명객체 결과: " + c1.add(3, 5)); }			
//		}; p1.print("Hello World");
		
//		Printer p2 = (String msg)->{ System.out.println("람다식 결과: " + c2.add(10, 20)); };
