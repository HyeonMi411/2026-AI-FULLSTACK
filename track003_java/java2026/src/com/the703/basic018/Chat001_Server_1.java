...
//		
//		try {
//			ascenter = new ServerSocket(703);	// 127.3.3.1:703	[ | | | | | ]
...
//		try {
//			while(out != null) { out.writeUTF( br.readLine()		); }			
//		}catch(Exception e) {
//			e.printStackTrace();
//		}finally {
//			try {
...
//   2) 클라이언트 연결 요청, 수락
//   3) 클라이언 소켓(socket) ↔ 상담사(socket) 가 읽어들이기 ( InputStream  > 프로그램기준 > OutputStream) 
// 
//*/
//
//
