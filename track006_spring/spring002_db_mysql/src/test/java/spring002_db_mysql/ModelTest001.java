...
public class ModelTest001 {
	...
	public void test6() {
		//5. 삭제
		System.out.println(   userinfo.delete(11)  );
		//4. 수정
		//		UserInfoDto dto = new UserInfoDto();  dto.setEmail("hello@gmail.com"); dto.setAge(100); dto.setNo(11);
		//		System.out.println( userinfo.update(dto));
		//3. 힌먕감섹
		System.out.println(  userinfo.select(11)  );
		//2. 삽입
