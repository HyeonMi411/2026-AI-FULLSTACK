...
public class BoardController {
	...
	//테스트 : http://localhost:8080/spring003_mvc/board/list.do		//테스트 : http://localhost:8080/string003_mvc/board/list.do
	
	//■2.	글쓰기 폼경로
	@RequestMapping( value="/board/write.do" , method=RequestMethod.GET)
	public String write() {   return "board/write"; }
	//테스트 : http://localhost:8080/spring003_mvc/board/write.do		//테스트 : http://localhost:8080/string003_mvc/board/write.do	
