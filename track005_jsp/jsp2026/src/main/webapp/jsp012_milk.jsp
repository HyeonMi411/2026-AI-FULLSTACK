...
<!-- https://www.w3schools.com/bootstrap5/bootstrap_tables.php -->
 <div class="container card my-5  bg-warning  text-white ">
      <h3 class="card-header">Milk 주문현황표</h3>  
...
<!-- https://www.w3schools.com/bootstrap5/bootstrap_collapse.php -->
   <div class="container card my-5  bg-secondary  text-white ">
		...
		<div id="accordion">
		      ...
		      <div class="card-body">
				...
				<script>
		      	function order(){
		      		...
		      		if(oname.value.trim() ==""){ alert("이름 칸을 확인해주세요"); oname.focus();	return false; }
		      		if(onum.value.trim()  ==""){ alert("갯수 칸을 확인해주세요"); onum.focus();	return false; }      		
		      		return true;      			
		      	}
				</script>
		      </div>
		    ...
		    <div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
		      <div class="card-body">		        
                 <form action="jsp012_update.jsp"  method="post"  onsubmit = "return order1()">
                    <div class="my-3">
                       <label for="ono1"  class="form-label">수정할 우유 번호</label>
                    ...
                    <div class="my-3">
                       <label for="onum1"  class="form-label">수정할 우유 갯수</label>
					...
					<script>
			      	function order1(){
			      		...
			      		if(ono1.value.trim() ==""){ alert("번호 칸을 확인해주세요"); ono1.focus();	return false; }
			      		if(oname1.value.trim()  ==""){ alert("이름 칸을 확인해주세요"); oname1.focus();	return false; }      		
			      		if(onum1.value.trim()  ==""){ alert("갯수 칸을 확인해주세요"); onum1.focus();	return false; }      		
			      		return true;      			
			      	}
					</script>                 
		      </div>
		  ...
		  <div class="card">
		    ...
		    <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
		      <div class="card-body">		        
                 <form action="jsp012_select.jsp"  method="post"  onsubmit = "return order2()">
                    <div class="my-3">
                       <label for="ono2"  class="form-label">조회할 주문 번호</label>
                       <input type="text" class="form-control"  id="ono2"   name="ono" />
                    </div>
                    <div class="my-3"> 
                       <button  type="submit"  class="btn btn-warning" >  조회하기 </button>
                    </div>
                 </form>
					<script>
			      	function order2(){
			      		let ono2 = document.getElementById("ono2");      		
			      		if(ono2.value.trim() ==""){ alert("번호 칸을 확인해주세요"); ono2.focus();	return false; }      		
			      		return true;      			
			      	}
					</script>                    
		      </div>
		  ...
		  <div class="card">
		    ...
		    <div id="collapseThree" class="collapse" data-bs-parent="#accordion">
		      <div class="card-body">		        
               <form action="jsp012_delete.jsp"    method="get"  onsubmit = "return order3()">
                 <div class="mb-3">
                ...
                <script>
		      	function order3(){
		      		let ono_delete = document.getElementById("ono_delete");      		
		      		if(ono_delete.value.trim() ==""){ alert("번호 칸을 확인해주세요"); ono_delete.focus();	return false; }      		
		      		return true;      			
		      	}
				</script>  
		      </div>
