...
<%
   // jsp012_insert.jsp
   	...
   	try{
   		...
   		String sql = "select * from milk_order where ono=?";
   		...
   		if (result > 0) {
   			out.println("<script> alert('조회 성공!');  location.href='jsp012_milk.jsp';	</script>");
   		}else{
   			out.println("<script> alert('조회 실패!');  location.href='jsp012_milk.jsp';	</script>");   			
   		}
