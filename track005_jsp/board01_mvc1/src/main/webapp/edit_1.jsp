...
//3. view 받아온데이터 넣기
   ...
   //2. sql 구문 2개 처리
   String bname = "",  bpass="", btitle="", bcontent=""; int bhit=0; 
   try{ 
   ...
   <div class="container card my-5">
      ...
      <form  action ="edit_action.jsp"  method="post"   onsubmit="return checkForm()">
         ...
         <div  class="my-3">
            ...
            <input type="password"   class="form-control" value="<%=bpass%>"   id="bpass"  name="bpass"  />
         </div>
         <div  class="my-3">
         ...
         <div  class="my-3">
            ...
            <textarea  class="form-control" value="<%=bcontent%>"   id="bcontent"  name="bcontent"  ></textarea>
         </div>
